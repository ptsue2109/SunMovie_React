...
const items: MenuItem[] = [
  ...
  getItem("Quản lí Vé", "adminTicketPrice", <RiTicket2Line />, [
    getItem(
  ...
  getItem("Quản lí Chi Tiết Food", "AdminFoodDetail", <RiGobletFill />, [
    getItem(
      <Link to={config.routes.AdminFoodDetail}> Xem Chi Tiết Đồ Ăn</Link>,
      "AdminFoodDetail1"
    ),
    getItem(
  ...
  getItem("Quản lí Loại Ghế", "adminSeatType", <MdEventSeat />, [
    ...
    getItem(
      <Link to={config.routes.adminSeatTypeAdd}> Thêm ghế</Link>,
      "adminSeatType2"
    ),
  ]),
  getItem("Quản lí Phòng chiếu", "adminRooms", <GiTheater />, [
    getItem(
      <Link to={config.routes.adminRooms}> Danh sách rạp</Link>,
      "adminRooms1"
    ),
    getItem(
      <Link to={config.routes.adminRoomsCreate}> Thêm rạp</Link>,
      "adminRooms2"
    ),
  ]),
  getItem("Quản lí Giờ chiếu", "AdminShowTimes", <FcOvertime />, [
    ...
    getItem(
      <Link to={config.routes.AdminShowTimesCreate}> Thêm giờ chiếu</Link>,
      "AdminShowTimes2"
    ),
  ]),
  ...
  getItem("Quản lí Format Film", "AdminFilmFormat", <FcOvertime />, [
    getItem(
      <Link to={config.routes.AdminFilmFormat}> Xem tất cả</Link>,
      "AdminFilmFormat1"
    ),
  ]),

  getItem("Quản lí phim ", "sub7", <UserOutlined />, [
    getItem(<Link to={config.routes.adminMovie}> Danh sách phim</Link>, "13"),
